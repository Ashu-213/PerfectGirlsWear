...
function Hero() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden pt-[72px]">
      {/* Background gradient */}
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#f7efe9] via-[#fadadd]/40 to-[#f7efe9]" />
      {/* abstract shape */}
      <div
        className="absolute -right-40 top-20 -z-10 h-[700px] w-[700px] rounded-full bg-blush/30 blur-3xl"
        aria-hidden
      />
      <div
        className="absolute -left-40 bottom-0 -z-10 h-[500px] w-[500px] rounded-full bg-rose/10 blur-3xl"
        aria-hidden
      />

      {/* Floral SVG decorations */}
      <FloralCluster className="absolute left-6 top-24 h-32 w-32 opacity-80 sm:h-40 sm:w-40" />
      <FloralCluster className="absolute right-6 bottom-12 h-28 w-28 opacity-60" flip />
      ...
      <div className="pointer-events-none absolute inset-x-0 top-[20%] z-0 flex flex-col items-center select-none">
        <span
          ...
          style={{ fontSize: "clamp(80px, 14vw, 220px)", lineHeight: 0.9 }}
        >
          PERFECT
        </span>
        <span
      ...
      <div className="container-editorial relative z-10 grid min-h-[calc(100vh-72px)] grid-cols-1 items-center gap-8 py-12 lg:grid-cols-12">
        {/* Left: silhouette / brand intro */}
        <div className="lg:col-span-6 flex flex-col items-start reveal">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/60 px-4 py-1.5 backdrop-blur-sm">
            <Petal size={14} />
          ...
          <p className="font-editorial text-2xl text-charcoal/80 mt-6 max-w-md">
            नए फैशन का <span className="text-rose">परफेक्ट स्टाइल</span>
          </p>

          <p className="text-sm leading-relaxed text-muted-ink mt-4 max-w-md">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#collections"
              className="inline-flex items-center gap-2 rounded-full bg-rose px-7 py-3.5 text-[13px] font-semibold uppercase tracking-[0.08em] text-white transition-all hover:scale-[1.03] hover:shadow-[var(--shadow-rose-glow)]"
            >
              Explore Collections
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full border border-charcoal/30 bg-transparent px-7 py-3.5 text-[13px] font-semibold uppercase tracking-[0.08em] text-charcoal transition-all hover:bg-charcoal hover:text-white"
            >
        ...
        <div className="lg:col-span-6 relative reveal" style={{ animationDelay: "0.2s" }}>
          <div className="relative aspect-[3/4] w-full overflow-hidden rounded-[24px] shadow-[var(--shadow-luxury)]">
            <img
              src={heroModels}
          ...
          {/* floating badge */}
          <div className="absolute -left-4 -bottom-6 sm:-left-10 sm:-bottom-8 bg-charcoal text-white rounded-2xl px-6 py-4 shadow-2xl border border-rose/40 max-w-[240px]">
...
function Collections() {
  return (
    <section id="collections" className="bg-cream py-24 md:py-32">
    ...
    <section id="about" className="bg-white py-24 md:py-32">
      <div className="container-editorial grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
        <div className="lg:col-span-7 relative">
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[20px] shadow-[var(--shadow-luxury)]">
            <img
        ...
        <div className="lg:col-span-5">
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {features.map(({ icon: Icon, label }) => (
              <div
                key={label}
                className="rounded-xl bg-cream p-4 text-center transition hover:-translate-y-1 hover:shadow-[var(--shadow-soft)]"
              >
...
function Occasions() {
  return (
    <section id="occasions" className="bg-cream py-24 md:py-32">
      <div className="container-editorial">
      ...
      <div className="container-editorial">
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5">
          {items.map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="rounded-2xl border border-white/10 bg-white/[0.04] p-8 text-center transition hover:bg-white/[0.07] hover:border-rose/30 hover:shadow-[0_8px_32px_rgba(232,109,141,0.15)]"
            >
...
function Showroom() {
  return (
    <section id="showroom" className="bg-ink py-24 md:py-32">
      <div className="container-editorial">
        <SectionHeader
      ...
      <div className="mt-14 overflow-x-auto pb-8 [&::-webkit-scrollbar]:hidden" style={{ scrollSnapType: "x mandatory" }}>
        <div className="flex gap-6 px-[max(15vw,40px)]">
          {showroom.map((s, i) => (
            <div
              key={i}
              className="relative flex-shrink-0 overflow-hidden rounded-2xl"
              style={{ width: "min(70vw, 900px)", aspectRatio: "16/10", scrollSnapAlign: "center" }}
            >
              <img src={s.img} alt={s.caption} loading="lazy" className="h-full w-full object-cover" />
      ...
      <div className="container-editorial max-w-[1200px]">
        ...
        <div className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-3">
          {testimonials.map((t) => (
            <article
              key={t.name}
              className="relative rounded-2xl bg-white p-10 shadow-[var(--shadow-soft)] transition hover:-translate-y-2 hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)]"
            >
              ...
              <p className="font-editorial text-xl leading-[1.6] text-charcoal mt-5">
                "{t.quote}"
              </p>
    ...
    <section className="bg-white py-24 md:py-32">
      ...
      <div className="mt-12 text-center">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 rounded-full bg-charcoal px-7 py-3.5 text-[13px] font-semibold uppercase tracking-[0.08em] text-white transition hover:bg-rose hover:shadow-[var(--shadow-rose-glow)]"
        >
...
function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden bg-ink py-32 md:py-40">
      <div
      ...
      <div className="container-editorial relative">
        <div className="mx-auto max-w-[920px] rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-2xl sm:p-14 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_40px_80px_rgba(0,0,0,0.3)]">
          <div className="text-center">
          ...
          <div className="mt-12 grid gap-12 md:grid-cols-2">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] p-8 transition hover:border-rose/40"
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full bg-rose px-8 py-4 text-[13px] font-semibold uppercase tracking-[0.08em] text-white transition hover:scale-[1.02] hover:shadow-[0_8px_30px_rgba(232,109,141,0.4)]"
            >
              <MessageCircle className="h-4 w-4" />
              Chat on WhatsApp
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full border border-white/20 px-8 py-4 text-[13px] font-semibold uppercase tracking-[0.08em] text-white transition hover:bg-white hover:text-charcoal"
            >
...
function ContactRow({
  ...
  return (
    ...
    >
      <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-rose/15 text-rose">
